...
export const tokenSwapAbi = [
  {
    ...
    inputs: [
      ...
      { name: '_token2', internalType: 'address', type: 'address' },
    ],
    stateMutability: 'nonpayable',
  },
  {
    type: 'function',
    inputs: [
      { name: '_token1Amount', internalType: 'uint256', type: 'uint256' },
      { name: '_token2Amount', internalType: 'uint256', type: 'uint256' },
    ],
    name: 'addLiquidity',
    outputs: [
      { name: 'liquidityAdded', internalType: 'uint256', type: 'uint256' },
    ],
    stateMutability: 'nonpayable',
  },
  {
    ...
    name: 'getBalances',
    outputs: [
      { name: 'token1Balance', internalType: 'uint256', type: 'uint256' },
      { name: 'token2Balance', internalType: 'uint256', type: 'uint256' },
    ],
    stateMutability: 'view',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      { name: 'token1Amount', internalType: 'uint256', type: 'uint256' },
      { name: 'token2Amount', internalType: 'uint256', type: 'uint256' },
    ],
    stateMutability: 'nonpayable',
  },
  {
